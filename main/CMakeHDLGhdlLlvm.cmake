...
function(CMakeHDL_add_build_library_command library_name)
    cmake_parse_arguments(args "VHDL_RELAXED_RULES" "OUTPUT_FILE_VARIABLE;WORKING_DIRECTORY" "DEPENDS;SOURCES" ${ARGN})
    set(output_file "${args_WORKING_DIRECTORY}/.touch")
    set(build_args "")
    list(APPEND build_args ${CMakeHDLGhdlLlvm_VHDL_STANDARD_ARG})
    if(args_VHDL_RELAXED_RULES)
        list(APPEND build_args "-frelaxed")
    endif()
...
function(CMakeHDL_add_build_simulation_command name)
    cmake_parse_arguments(args "VHDL_RELAXED_RULES" "OUTPUT_FILE_VARIABLE;VHDL_TOP_ARCHITECTURE;VHDL_TOP_CONFIGURATION;VHDL_TOP_ENTITY;WORK_LIBRARY;WORKING_DIRECTORY" "DEPENDS" ${ARGN})
    set(output_file "${args_WORKING_DIRECTORY}/.touch")
    ...
    if(args_VHDL_RELAXED_RULES)
        list(APPEND elab_args "-frelaxed")
    endif()
